    ...
    const autoReplyOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-top: 30px; padding: 20px; background-color: #678bb9ff; color: white; border-radius: 8px; text-align: center;">
            <h3 style="margin-top: 0; color: white;">Lasindu Themiya</h3>
            <p style="margin: 5px 0; color: #e8f4fd;">Software Engineering Student & Co-Founder of WorkMate</p>
